...
const service_img = "https://cdn.builder.io/api/v1/image/assets%2F684854aee2e544198255ca998eb85257%2Fc9ab9ea43e5b4412920f75a80754c461?format=webp&width=800";

const bg_img = "linear-gradient(135deg, #ff4757 0%, #ff3838 50%, #c44569 100%)";

const CarpetCleaningDetailsArea = () => {
                     ...
                     <div className="sv-details-widget">
                        ...
                        <div className="tp-service__dashboard mb-30" style={{background: bg_img}}>
                           <div className="tp-service__top-content">
                              <h3 className="tp-service__title-white" suppressHydrationWarning>{t('content.professionalCarpetCleaningServices')}</h3>
                              <p suppressHydrationWarning>{t('content.deepCleaningAllCarpetTypes')}</p>
                  ...
                  <div className="col-xl-8 col-lg-8">
                     <div className="sv-details-wrapper">
                        <div className="sv-details-thumb mb-45">
                           <Image className="w-100" src={service_img} alt="Carpet Cleaning Service" width={800} height={600} />
                        </div>
                        <div className="sv-details-title-box mb-55">
                           <h4 className="sv-details-title" suppressHydrationWarning>{t('serviceDetails.carpetCleaningTitle')}</h4>
                           <p suppressHydrationWarning>{t('serviceDetails.carpetCleaningDescription')}</p>
                        </div>
                        <div className="sv-details-text mb-35">
                           <h4 className="sv-details-text-title pb-10" suppressHydrationWarning>{t('content.ourSpecializedServices')}</h4>
                           <ul>
                              <li>
                        ...
                        <div className="sv-details-text-2">
                           <h4 className="sv-details-text-title" suppressHydrationWarning>{t('serviceDetails.carpetWhyChooseTitle')}</h4>
                           <p suppressHydrationWarning>{t('serviceDetails.carpetWhyChooseDescription')}</p>
                        </div>
...
export default CarpetCleaningDetailsArea;
