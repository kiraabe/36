...
import { useTranslatableTestimonialData } from '@/src/hooks/useTranslatableTestimonialData';
...
const TestimonialArea = () => {
   ...
   const testimonialData = useTranslatableTestimonialData();
                  ...
                  <div className="row justify-content-center">
                     <div className="col-xl-6">
                        <div className="tp-testimonial__section-box text-center">
                           <h3 className="tp-section-title">{t('testimonials.clientsSay')}</h3>
                           <p>{t('testimonials.starsReview')}</p>
                                       ...
                                       <div className="col-xl-5 col-lg-5">
                                          <div className="tp-testimonial__right-item d-flex flex-column justify-content-between">
                                             ...
                                             <div className="tp-testimonial__link">
                                                <Link href="/about">
                                                   {t('buttons.viewServiceDetails', { ns: 'common' })}
                                                   <RightArrow />
                                                </Link>
                                             </div>
                                          </div>
