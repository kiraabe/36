...
const service_img = "https://cdn.builder.io/api/v1/image/assets%2F684854aee2e544198255ca998eb85257%2Fdd1d0ab14d5d4802a0e6e917c069be5e?format=webp&width=800";

const bg_img = "linear-gradient(135deg, rgb(0 0 0) 0%, rgb(255 0 0 / 41%) 50%, rgb(0 0 0 / 58%) 100%)";

const DeepCleaningDetailsArea = () => {
                     ...
                     <div className="sv-details-widget">
                        ...
                        <div className="tp-service__dashboard mb-30" style={{background: bg_img}}>
                           <div className="tp-service__top-content">
                              <h3 className="tp-service__title-white">{t('deepCleaningDetails.comprehensiveDeepCleaningTitle', { ns: 'services' })}</h3>
                              <p>{t('deepCleaningDetails.comprehensiveDescription', { ns: 'services' })}</p>
                  ...
                  <div className="col-xl-8 col-lg-8">
                     <div className="sv-details-wrapper">
                        <div className="sv-details-thumb mb-45">
                           <Image className="w-100" src={service_img} alt="Deep Cleaning Service" width={800} height={600} />
                        </div>
                        <div className="sv-details-title-box mb-55">
                           <h4 className="sv-details-title">{t('serviceDetails.deepCleaningTitle', { ns: 'services' })}</h4>
                           <p>{t('deepCleaningDetails.overviewDescription', { ns: 'services' })}</p>
                        </div>
                        <div className="sv-details-text mb-35">
                           <h4 className="sv-details-text-title pb-10">{t('deepCleaningDetails.specializedServicesTitle', { ns: 'services' })}</h4>
                           <ul>
                            <li><i className="fal fa-check"></i><p>{t('deepCleaningDetails.officeCleaningItem', { ns: 'services' })}</p></li>
                            <li><i className="fal fa-check"></i><p>{t('deepCleaningDetails.washingDishesItem', { ns: 'services' })}</p></li>
                            <li><i className="fal fa-check"></i><p>{t('deepCleaningDetails.dustingVacuumingItem', { ns: 'services' })}</p></li>
                            <li><i className="fal fa-check"></i><p>{t('deepCleaningDetails.toiletCleaningItem', { ns: 'services' })}</p></li>
                           </ul>
                        </div>
                        <div className="sv-details-text-2">
                           <h4 className="sv-details-text-title">{t('deepCleaningDetails.whyChooseTitle', { ns: 'services' })}</h4>
                           <p>{t('deepCleaningDetails.whyChooseDescription', { ns: 'services' })}</p>
                        </div>
...
export default DeepCleaningDetailsArea;
