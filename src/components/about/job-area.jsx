...
const job_data = {
    ...
    title: <>Join our Growing Team <br /> of Professionals</>,
    carrer_title: "Open Positions",
    carrer_info: <>We're always looking for dedicated cleaning professionals who take pride in their work. <br/>
    Join our team and be part of something great.</>,
    job_info: [
        {
            id:1,
            category: "Residential Cleaner",
            job_time: "Full-time",
            job_location: "Newark, NJ",
        },
        {
            id:2,
            category: "Commercial Cleaner",
            job_time: "Full-time",
            job_location: "London, UK",
        },
        {
            id:3,
            category: "Carpet Cleaning Specialist",
            job_time: "Part-time",
            job_location: "Brooklyn, NY",
        },
        {
            id:4,
            category: "Window Cleaning Technician",
            job_time: "Full-time",
            job_location: "Newark, NJ",
        },
        {
