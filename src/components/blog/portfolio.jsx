                  ...
                  <div className="row justify-content-center">
                     <div className="col-lg-8">
                        <div className="tp-about__section-box text-center mb-40">
                           <h4 className="inner-section-subtitle">OVER 500+ SATISFIED CLIENTS</h4>
                           <h3 className="tp-section-title">Spotless Results, Every Time</h3>
                           <p>Your trusted resource for professional cleaning tips and industry insights.</p>
                        </div>
                     </div>
                  </div>
                  <div className="row">
