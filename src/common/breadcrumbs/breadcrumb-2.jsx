...
const shape_3 = "https://cdn.builder.io/api/v1/image/assets%2F502af3714cbb44bab6c5decbdffe176f%2F1bc56307182046cc9d6ad93e0a9c537f?format=webp&width=800";
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-5 col-lg-4 text-center text-md-end">
              <div className="breadcrumb__img p-relative text-start z-index">
                <Image className="z-index-3" src={shape_3} alt="theme-pure" width={400} height={400} />
                <div
